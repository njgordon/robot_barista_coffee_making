...
get_filename_component(_filename "/home/nathan/barista_ws/src/manipulation/srv/ReturnJointStates.srv" NAME_WE)
add_custom_target(_manipulation_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "manipulation" "/home/nathan/barista_ws/src/manipulation/srv/ReturnJointStates.srv" ""
)
...
_generate_srv_cpp(manipulation
  "/home/nathan/barista_ws/src/manipulation/srv/ReturnJointStates.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/manipulation)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/manipulation\")")
  # install generated code
  install(
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/manipulation/.+/__init__.pyc?$"
  )
endif()
